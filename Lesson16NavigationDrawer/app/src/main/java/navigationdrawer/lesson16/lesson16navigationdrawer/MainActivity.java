package navigationdrawer.lesson16.lesson16navigationdrawer;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (drawer.getDrawerLockMode(navigationView) == DrawerLayout.LOCK_MODE_UNLOCKED) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.addCustomMenu) {
            navigationView.getMenu().clear();
            navigationView.inflateMenu(R.menu.custom_menu);
        } else if (id==R.id.addStandartMenu){
            navigationView.getMenu().clear();
